...
<html>
    ...
    <body>
        ...
        <div class="wrapper" style=" background: linear-gradient(to bottom right, #BCE0FD, #89CFF0, #6D7B8D);">

            <div class="login_box">
                
                <div class="login_header">
                    <img src="assets/images/logos/chatter_logo.png" style="max-width: 200px; border-radius: 20%; margin-top: 10px;" class="responsiveImg" alt=""/>
